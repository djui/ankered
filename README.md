...
Download `AnkerPower-1.2.5.zip` from the [latest GitHub Release](https://github.com/djui/ankered/releases/latest), unzip it, and move `AnkerPower.app` to `/Applications`.
...
./scripts/release.sh --publish 1.2.5
```
